  ...
  <main class="background">
    ...
    <div class="container">
      ...
      <table class="table">
        ...
        <b-modal id="modal-editarempresa" title="Editar Empresa" ok-title="Confirmar" cancel-title="Cancelar"
          @ok="editarEmpresa()">
          <div class="form-group">
            <label for="email">CNPJ:</label>
            <input v-model="empresa.cnpj" class="form-control" type="number" placeholder="CNPJ"
              v-maska="'##.###.###/####-##'" required />
          </div>
          <div class="form-group">
            <label for="number">Nome da empresa:</label>
            <input v-model="empresa.nomeEmpresa" class="form-control" type="text" placeholder="Nome da Empresa"
              required />
          </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input v-model="empresa.nomeResponsavel" class="form-control" type="text" placeholder="Nome da Empresa"
                required />
            </div>

            <div class="form-group">
              <label for="email">Contato do responsável:</label>
              <input v-model="empresa.contatoResponsavel" class="form-control" type="text"
                placeholder="Contato do Responsável" required />
            </div>

            <div class="form-group">
              <label for="email">Endereço:</label>
              <input v-model="empresa.endereco" class="form-control" type="text" placeholder="Endereço da Empresa"
                required />
            </div>
        ...
        <tbody v-for="empresa in empresasFiltradas" :key="empresa.id">
          <tr>
            ...
            <td>{{ empresa.email }}</td>
            <td>
              <b-button style="background-color: #b33939" v-b-modal.modal-1 @click="id = empresa.id">
                <b-icon-trash></b-icon-trash>
              </b-button>

              <b-button style="background-color: #2980b9" v-b-modal.modal-editarempresa
